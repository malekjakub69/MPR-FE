    ...
    return (
        <div className="matrix">
            ...
            <div className="grid5x5">
                ...
                <div className="cell" style={{backgroundColor:"orange"}}><p className="center">{matrixData[1]}</p></div>
                <div className="cell" style={{backgroundColor:"red"}}><p className="center">{matrixData[2]}</p></div>
                <div className="cell" style={{backgroundColor:"red"}}><p className="center">{matrixData[3]}</p></div>
                <div className="cell" style={{backgroundColor:"red"}}><p className="center">{matrixData[4]}</p></div>
                ...
                <div className="cell" style={{backgroundColor:"orange"}}><p className="center">{matrixData[6]}</p></div>
                <div className="cell" style={{backgroundColor:"orange"}}><p className="center">{matrixData[7]}</p></div>
                <div className="cell" style={{backgroundColor:"red"}}><p className="center">{matrixData[8]}</p></div>
                <div className="cell" style={{backgroundColor:"red"}}><p className="center">{matrixData[9]}</p></div>
                <div className="category" style={{color:"grey"}}><p className="center">MEDIUM</p></div>
                <div className="cell" style={{backgroundColor:"green"}}><p className="center">{matrixData[10]}</p></div>
                <div className="cell" style={{backgroundColor:"yellow"}}><p className="center">{matrixData[11]}</p></div>
                <div className="cell" style={{backgroundColor:"orange"}}><p className="center">{matrixData[12]}</p></div>
                <div className="cell" style={{backgroundColor:"orange"}}><p className="center">{matrixData[13]}</p></div>
                <div className="cell" style={{backgroundColor:"red"}}><p className="center">{matrixData[14]}</p></div>
                <div className="category" style={{color:"grey"}}><p className="center">LOW</p></div>
                <div className="cell" style={{backgroundColor:"green"}}><p className="center">{matrixData[15]}</p></div>
                <div className="cell" style={{backgroundColor:"yellow"}}><p className="center">{matrixData[16]}</p></div>
                <div className="cell" style={{backgroundColor:"yellow"}}><p className="center">{matrixData[17]}</p></div>
                <div className="cell" style={{backgroundColor:"orange"}}><p className="center">{matrixData[18]}</p></div>
                <div className="cell" style={{backgroundColor:"orange"}}><p className="center">{matrixData[19]}</p></div>
                <div className="category" style={{color:"grey"}}><p className="center">TINY</p></div>
                <div className="cell" style={{backgroundColor:"green"}}><p className="center">{matrixData[20]}</p></div>
                <div className="cell" style={{backgroundColor:"green"}}><p className="center">{matrixData[21]}</p></div>
                <div className="cell" style={{backgroundColor:"green"}}><p className="center">{matrixData[22]}</p></div>
                <div className="cell" style={{backgroundColor:"yellow"}}><p className="center">{matrixData[23]}</p></div>
                <div className="cell" style={{backgroundColor:"yellow"}}><p className="center">{matrixData[24]}</p></div>
